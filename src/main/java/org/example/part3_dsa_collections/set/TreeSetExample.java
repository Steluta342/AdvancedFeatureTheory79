...
public class TreeSetExample {
    ...
    static class AnimalComparable implements Comparable<AnimalComparable> {
        ...
        //Intr-un compator depinde foarte mult de ordinea de comparatie intre elemente. Adica cine e primul.
        @Override
        public int compareTo(AnimalComparable other) {
            int result = Double.compare(this.weight, other.weight);//233 ? 500 => 233<500 => result < 0 => ordinea este descrescatoare
    ...
    public static void main(String[] args) {
        ...
        comparableSet.add(new AnimalComparable("Girafa", 5, 300.2));
        comparableSet.add(new AnimalComparable("Girafa", 7, 300.3));
        ...
        //Exemplu cu Comparator
        /*Comparator*/
        Comparator<AnimalComparator> comparatorForAnimals = Comparator.comparingInt(AnimalComparator::getAge)
                .thenComparing(AnimalComparator::getName)
                .thenComparing((AnimalComparator it1, AnimalComparator it2) -> Double.compare(it2.getWeight(), it1.getWeight()))
                .reversed();// nu inverseaza regula de comparatie, ci interg setul
        //(it1, it2) -> Integer.compare(it1.getAge(), it2.getAge(), it1 = this, it2 = other)
        ...
        comparatorSet.add(new AnimalComparator("Elefant", 12, 1000));
